...
private:
    ...
    void checkMetric(const string &metric) const;
    void checkIndex(int index) const;
    int caculatingFirst(const SinglyLinkedList<float> &query, double (VectorStore::*func)(const SinglyLinkedList<float> &, const SinglyLinkedList<float> &) const, bool minimize) const;
    void merge(Data arr[], Data left[], int leftSize, Data right[], int rightSize, bool minimize) const;
    void recursiveMergeSort(Data arr[], int left, int right, bool minimize) const;
    int* caculatingTopK(const SinglyLinkedList<float> &query, int k, double (VectorStore::*func)(const SinglyLinkedList<float> &, const SinglyLinkedList<float> &) const, bool minimize) const;
